...
<li class="nav-item"><a id="Nav_btn_books_atrasos" class="nav-link ${selectedPage == 1 ? "active" : ""} link-body-emphasis" aria-current="page" href="/atrasados"><svg class="me-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="1em" height="1em" fill="currentColor">
